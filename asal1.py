#Karekök fonksiyonunu asal sayıları belirlemek için de kullanabiliriz.
#Bütün olasılıkları (n ve n-1 için) denemek yerine n değerinin karekök sonucuna
#kadar olan değerleri denememiz yeterli olacaktır.
